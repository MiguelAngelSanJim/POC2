class SnakeRace {
	...
	procesarComando = (comando) => {
	  const keys = ['arriba', 'abajo', 'izquierda', 'derecha']
  
	  if (comando.includes('arriba') && this.cabeza.dir !== 2)
		this.cabeza.giro = 0
	  else if (comando.includes('abajo') && this.cabeza.dir !== 0)
		this.cabeza.giro = 2
	  else if (comando.includes('izquierda') && this.cabeza.dir !== 1)
		this.cabeza.giro = 3
	  else if (comando.includes('derecha') && this.cabeza.dir !== 3)
		this.cabeza.giro = 1
	}
	presentar = () => {
	...
	finalizar = (tipo = 1) => {
		...
		switch (tipo) {
		  case 0: // Colisión con bordes
			...
			mensaje = "¡Has chocado con el borde! Fin del juego."
			break;
		  case 1: // Colisión con barrera
			img.src = this.imgChoque2.src
			mensaje = "¡Has chocado con una barrera! Fin del juego."
			break;
		  case 2:	// Abandono
			img.src = this.imgAbandono.src
			mensaje = "Te has quedado sin combustible o neumáticos. Fin del juego."
			break;
		}
		...
		// Utilizamos SpeechSynthesis para leer el mensaje
